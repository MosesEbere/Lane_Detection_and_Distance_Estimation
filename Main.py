'''
This project was partly made possible by the following resources:
1. https://www.youtube.com/watch?v=eLTLtUVuuy4
2. https://www.udemy.com/course/applied-deep-learningtm-the-complete-self-driving-car-course/
3. Chu Jiangwei et al. “Study on method of detecting preceding vehicle based on monocular camera”.
In: IEEE Intelligent Vehicles Symposium, 2004. IEEE. 2004, pp. 750–755.
'''
...
def ROI(img):
    ...
    r_o_i = np.array([[
        (0, row), (column, row), (round(0.9*column), round(0.3*row)),
